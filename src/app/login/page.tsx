...
export default function LoginPage() {
    ...
    return (
        <FullScreenMessage>
            <Image src="/arcly-logo.svg" alt="Arcly" width={160} height={45} priority />
            <p className="text-base opacity-60">Sign in to your teaching workspace</p>
            <Button onClick={signInWithGoogle} className="flex items-center gap-3 px-6 py-3">
                <GoogleIcon />
                Sign in with Google
            </Button>
        </FullScreenMessage>
